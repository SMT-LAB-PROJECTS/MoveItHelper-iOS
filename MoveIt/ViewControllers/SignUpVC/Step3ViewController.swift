...
class Step3ViewController: UIViewController {
    ...
    func setupUI(){
        ...
        headerView.frame.size.height = SCREEN_HEIGHT - 128
    ...
    func savePhotos(){
        ...
        let parameter = ["vehicle_image_url": [imgWithKey[0]!,imgWithKey[1]!,imgWithKey[2]!,imgWithKey[3]!]] as Parameters
        ...
        AF.request(baseURL + helper_signup_step3, method: .post, parameters: parameter,encoding: JSONEncoding.default,  headers: header).responseJSON { (response) in
            ...
            case .success:
                if response.response?.statusCode == 200{
                    ...
                    if !resposneDict.isEmpty{
                        UserCache.shared.updateUserProperty(forKey: kUserCache.completedStep, withValue:  3 as AnyObject)
...
extension Step3ViewController:UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
...
extension Step3ViewController: UIImagePickerControllerDelegate,UINavigationControllerDelegate{
    //********************************
...
extension Step3ViewController:AlertViewPermmisionDelegate{
